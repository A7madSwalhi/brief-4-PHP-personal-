...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST)) {
    ...
    $data = [
      ...
      db_update("categories",$data,$_GET['id']);
...
function db_update(string $table, array $data, $id): array
    {
        ...
        $sql .=  $column_value . "WHERE category_id=" . $id;



        mysqli_query($conn, $sql);
        $first = mysqli_query($conn, "SELECT * FROM " . $table . " WHERE category_id=" . $id);
                                        ...
                                        <div class="account-details-form">
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="single-input-item mb-3">
                                                    ...
                                                    <input type="text" id="category-name" name="category_name" placeholder="Category Name" value="<?php echo $cu['name']?>" />
                                                </div>
                                                <div class="single-input-item mb-3">
                                                    <label for="description" class="required mb-1">Description</label>
                                                    <textarea id="description" name="description" placeholder="Description" ><?php echo $cu['description']?></textarea>
                                                </div>
