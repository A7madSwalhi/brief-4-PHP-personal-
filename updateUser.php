...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST)) {
    ...
    if (isset($_FILES['profile_picture']['full_path'])) {
      move_uploaded_file( $_FILES['profile_picture']['tmp_name'],"uploaded_img/".$_FILES['profile_picture']['full_path']);
      $data = [
      'name ' => $_POST['username'],
      'email ' => $_POST['email'],
      
      'user_type' => $_POST['user_type'],
      'image' => $_FILES['profile_picture']['full_path']
                    ...
                    <div class="account-details-form">
                      <form action="" method="post" enctype="multipart/form-data">
                        <div class="single-input-item mb-3">
                          ...
                          <input type="text" id="username" name="username" placeholder="Username" value="<?php echo $cu['name'] ?>"/>
                        </div>
                        <div class="single-input-item mb-3">
                          <label for="email" class="required mb-1">Email</label>
                          <input type="email" id="email" name="email" placeholder="Email" value="<?php echo $cu['email'] ?>" />
                        </div>
                        
                        <div class="single-input-item mb-3">
                          <label for="profile-picture" class="required mb-1">Profile Picture</label>
                          <input type="file" id="profile-picture" name="profile_picture"  />
                        </div>
                        <div class="single-input-item mb-3">
                          <label for="user-type" class="required mb-1">User Type</label>
                          <select id="user-type" name="user_type" require>
                            <?php if($cu['user_type'] == 'user'){
