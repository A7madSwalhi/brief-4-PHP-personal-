...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST)) {
    ...
    if (isset($_FILES['product_image']['full_path'])) {
      move_uploaded_file( $_FILES['product_image']['tmp_name'],"uploaded_img/".$_FILES['product_image']['full_path']);
      $data = [
      ...
      'price' => $_POST['price'],
      'stock' => $_POST['stock'],
      'path' => $_FILES['product_image']['full_path'],
      'discount'=> $_POST['discount']
      ];

      db_update("products",$data,$_GET['id']);
                        ...
                        <div class="account-details-form">
                          <form action="" method="post" enctype="multipart/form-data">
                            <div class="single-input-item mb-3">
                              ...
                              <input type="text" id="product-name" name="product_name" placeholder="Product Name" value="<?php echo $cu['name'] ?>" required />
                            </div>
                            <div class="single-input-item mb-3">
                              <label for="category-id" class="required mb-1">Category ID</label>
                              <input type="text" id="category-id" name="category_id" placeholder="Category ID" value="<?php echo $cu['category_id'] ?>" required />
                            </div>
                            <div class="single-input-item mb-3">
                              <label for="price" class="required mb-1">Price</label>
                              <input type="text" id="price" name="price" placeholder="Price" value="<?php echo $cu['price'] ?>" required />
                            </div>
                            <div class="single-input-item mb-3">
                              <label for="description" class="required mb-1">Description</label>
                              <textarea id="description" name="description" placeholder="Description"  required><?php echo $cu['description'] ?></textarea>
                            </div>
                            <div class="single-input-item mb-3">
                              <label for="stock" class="required mb-1">Stock</label>
                              <input type="text" id="stock" name="stock" placeholder="Stock" value="<?php echo $cu['stock'] ?>" required />
                            </div>
                            <div class="single-input-item mb-3">
                              <label for="discount" class="required mb-1">Discount</label>
                              <input type="text" id="discount" name="discount" placeholder="Discount" value="<?php echo $cu['discount'] ?>" required />
                            </div>
                            <!-- <div class="single-input-item mb-3">
                              <label for="product-image" class="required mb-1">Product Image</label>
                              <input type="file" id="product-image" name="product_image"  value="<?php echo $cu['path'] ?>"/>
                            </div> -->
