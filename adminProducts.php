<?php
  ...
  function db_get(string $table, string $condition): mixed
    {
        global $conn;
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="myaccount-tab-menu nav" role="tablist">
                    ...
                    <a href="adminProducts.php" class="active"><i class="fa-solid fa-boxes-stacked"></i> Products</a>
                  ...
                  <!-- Cart Table Area -->
                  <div class="cart-main-wrapper col-custom">
  <div class="cart-table table-responsive">
    <table class="table table-bordered">
      <thead>
        <tr>
          <th class="pro-id" style="width: 60px">Product ID</th>
          <th class="pro-thumbnail" style="width: 80px">Image</th>
          <th class="pro-category" style="width: 80px">Category ID</th>
          <!-- New column -->
          <th class="pro-title" style="width: 150px">Product</th>
          <th class="pro-price" style="width: 80px">Price</th>
          <th class="pro-description" style="width: 200px">Description</th>
          <th class="pro-stock" style="width: 80px">Stock</th>
          <th class="pro-discount" style="width: 80px">Discount</th>
          <th class="pro-crud" style="width: 100px">CRUD</th>
        </tr>
      </thead>
      <tbody>
        <?php while ($row = mysqli_fetch_assoc($data['query'])): ?>
        <tr>
          <td class="pro-id"><span><?php echo $row['id']; ?></span></td>
          <td class="pro-thumbnail">
            <img class="img-fluid" src="uploaded_img/<?php echo $row['path']; ?>" alt="Product" style="width: 60px; height: auto" />
          </td>
          <td class="pro-category"><span><?php echo $row['category_id']; ?></span></td>
          <!-- New data -->
          <td class="pro-title"><?php echo $row['name']; ?></td>
          <td class="pro-price"><span><?php echo $row['price']; ?></span></td>
          <td class="pro-description" style="width: 200px;"><?php echo $row['description']; ?></td>
          <td class="pro-stock"><span><?php echo $row['stock']; ?></span></td>
          <td class="pro-discount"><span><?php echo $row['discount']; ?>%</span></td>
          <td class="pro-crud">
            
            <a href="updateProduct.php?id=<?php echo $row['id']; ?>"><i class="lnr lnr-pencil"></i></a>
            <a href="deleteProduct.php?id=<?php echo $row['id']; ?>"><i class="lnr lnr-trash"></i></a>
          </td>
        </tr>
        <?php endwhile; ?>
      </tbody>
