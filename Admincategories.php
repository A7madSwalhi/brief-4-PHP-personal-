      ...
      <div class="col-lg-12 col-custom">
        ...
        <div class="myaccount-page-wrapper">
          ...
          <div class="row flex-column">
            <div class="col-lg-3 col-md-4 col-custom" style="margin-bottom:40px;">
            ...
            <div class="col-lg-12 col-md-8 col-custom">
                ...
                <div class="tab-pane fade active show" id="categories" role="tabpanel">
                  <div class="myaccount-content">
                      ...
                      <table class="table table-bordered table-fixed">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="updateCategory.php?id=<?php echo $row['category_id']; ?>" class="btn flosun-button secondary-btn theme-color rounded-0" style="padding: 0 8px;">Update</a>
                              <a href="deleteCategory.php?id=<?php echo $row['category_id']; ?>" class="btn flosun-button secondary-btn theme-color rounded-0" style="padding: 0 8px;">Delete</a>
                            </td>
                          </tr>
                          <?php endwhile; ?>
                        </tbody>
                    ...
                    <div class="text-center mt-3">
                      <a href="addCategory.php" class="btn flosun-button secondary-btn theme-color rounded-0">Add Category</a>
                    </div>
                  </div>
                </div>
