...
<html class="no-js" lang="en">
  ...
  <body>
        ...
        <div class="col-lg-12 col-custom">
          ...
          <div class="myaccount-page-wrapper">
            ...
            <div class="row flex-column">
              ...
              <div class="col-lg-12 col-md-4 col-custom">
    ...
    <tr>
        ...
        $imageSrc = isset($row['image']) && !is_null($row['image']) ? $row['image'] : 'default-image.jpg';
        
        ?>
        <td>
            <img src="uploaded_img/<?php echo htmlspecialchars($imageSrc); ?>" alt="User Picture" style="width: 50px; height: 50px;" />
        </td>
        <td><?php echo htmlspecialchars($row['name']); ?></td>
        <td><?php echo htmlspecialchars($row['email']); ?></td>
        <td><?php echo htmlspecialchars($row['user_type']); ?></td>
        <td>
            <a href="UpdateUser.php?id=<?php echo urlencode($row['user_id']); ?>" class="btn flosun-button secondary-btn theme-color rounded-0">Update</a>
            <a href="deleteUser.php?id=<?php echo urlencode($row['user_id']); ?>" class="btn flosun-button secondary-btn theme-color rounded-0">Delete</a>
        </td>
    </tr>
<?php endwhile; ?>
                      ...
                      <div class="text-center mt-3">
                        <a href="adduser.php" class="btn flosun-button secondary-btn theme-color rounded-0">Add User</a>
                      </div>
                    </div>
                  </div>
