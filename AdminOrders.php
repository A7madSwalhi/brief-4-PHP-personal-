...
session_start();
  ...
  function db_get(string $table, string $condition): mixed
    {
        global $conn;
        $sql = "SELECT orders.order_id ,users.name AS username , orders.total , orders.status , orders.status , orders.created_at FROM orders JOIN users ON orders.user_id = users.user_id" .  $condition;
              ...
              <div class="row">
                <div class="col-lg-3 col-md-4 col-custom">
                  <div class="myaccount-tab-menu nav" role="tablist">
                    ...
                    <a href="AdminOrders.php" class="active" ><i class="fa fa-cart-arrow-down"></i> Orders</a>
